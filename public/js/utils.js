    ...
    J.prototype.format = function(a, b) {
        ...
        a: {
            for (var e = 0 == (v(e, 20) || []).length || 2 == b ? v(e, 19) || [] : v(e, 20) || [], g, h = e.length, l = 0; l < h; ++l) {
                g = e[l];
                var n = x(g, 3);
                if (0 == n || 0 == d.search(t(g, 3, n - 1)))
                    if (n = new RegExp(t(g, 1)), M(n, d)) {
                        e = g;
                        break a
                    }
            }
    ...
    function Oa(a, b, c, d) {
        ...
        a: {
            ...
            if (0 <= g && Ea(b.substring(0, g)))
                for (var h = b.match(za), l = h.length, n = 1; n < l; ++n)
        ...
        try {
            ...
            if ("Invalid country calling code" == A && L.test(l)) {
                if (l = l.replace(L, ""), h = Ma(l, g, b, d, f), 0 == h) throw A;
            } else throw A;
        }
    ...
    */
    ...
    function Va(a) {
        for (var b = a.g.length, c = 0; c < b; ++c) {
            ...
            if (-1 != h.indexOf("|")) f = !1;
                ...
                n.length < l.b.e.length ? l = "" : (h = n.replace(new RegExp(h, "g"), g), l = h = h.replace(RegExp("9", "g"), l.qa));
    ...
    m("intlTelInputUtils.formatNumber", function(a, b, c) {
        try {
            ...
            var e = new Pa(b);
            b = "";
            for (var f = 0; f < d.length; f++) b = Xa(e, d.charAt(f));
            " " == b.charAt(b.length - 1) && (b = b.substr(0, b.length - 1));
            if (c) {
                var g = Xa(e, "5");
                " " == g.charAt(g.length - 1) && (g = g.substr(0, g.length - 1));
                isNaN(parseFloat(g.substr(g.length - 2, 1))) && (b = g.substr(0, g.length - 1))
            }
            return b
        } catch (h) {
            return a
    ...
    m("intlTelInputUtils.formatNumberByType", function(a, b, c) {
        try {
            var d = J.r(),
                e = W(d, a, b);
