...
// eg: `data-parsley-stop-on-first-failing-constraint="false"`
  var ParsleyDefaults = {
    ...
    excluded: 'input[type=button], input[type=submit], input[type=reset], input[type=hidden],input:hidden, #s2id_autogen1,.exclude',
...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  ...
  max:            "This value should be lesser than or equal to %s.",
    ...
    $(document).ready(function () {
      ...
      window.ParsleyValidator.addValidator('multipleof',
          function (value, requirement) {
            if(isNaN(value)) alert('Please enter a valid numer');
            return 0 === value % requirement;
          }, 32)
          .addMessage('en', 'multipleof', 'Amount should be multiple of 10');
