...
<div class="col-md-9">
  <form action="/profile_settings/update/" method="post" accept-charset="utf-8" enctype="multipart/form-data"  data-parsley-validate>
      {if $save}
      <div class="row">
        <div class="bg bg-success padding-20"> <i class="fa fa-warning"></i> {$phrase.profile_changed_successfully}!</div>
      </div>
      {/if}

              <div class="persnl-profl">{$phrase.personal_profile}</div>
              <div class="row">
                <div class="col-md-4">
                  <div class=""><img src="{$config.url}/images/person.png"></div>
                  <div class="">{$phrase.add_profile_photo}</div>
                </div>
              </div>
              <div class="row frm">
                <div class="col-md-6">
                  <input class="form-control" placeholder="First Name*" name="firstname" value="{$users.first_name}">
                </div>
                <div class="col-md-6">
