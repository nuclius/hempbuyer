    ...
    <div class="container-fluid grey-bg xs-pdlr">
        <div class="container dashboard-con m50">
            ...
            <div id="direct-buy" class="tab-pane white-bg active">
                  ...
                  <li class="active"><a class=""  href="{$config.url}/dashboard/seller/rejected">Rejected Proposals <i class="icon flaticon-shopping-cart" aria-hidden="true"></i></a></li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6">
                                                            <ul class="p0">
                                                                ...
                                                                <li class="item"><b class="caption">Quantity Available :  </b> <span> {$val.qty_request} </span></li>
              ...
              {/if}
                                                         ...
                                                         <div class="col-md-6 col-sm-6">
                                                            ...
                                                            <a class="w100" href="#viewMessage1" data-toggle="modal" data-target="#viewMessage1" data-record-mess="{$val.reject_mesg}"> View Message</a>
                                                            {/if}
                                                        </div>
