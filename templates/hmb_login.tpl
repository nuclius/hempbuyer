...
<div class="clearfix auth-container">
    <div class="auth-left login-padd"> 
        <div class="auth-content-wrapper max-595">
            ...
            <div class="form-head">Login as</div>
            ...
            <div class="ha-txt text-center">
                Don't You Have an Account ? <a href="{$config.url}/signup">Register</a> 
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                ...
                <button class="btn btn-prev login-redirect" id="login_thankyou_btn" data-dismiss="modal">
                    THANK YOU
                </button>
            </div> 
        </div>
