        ...
        <div class="db-content">
            <div class="db-menu">
                <ul class="">
                    ...
                    <li><a href='/inbox/archive' class="active">Archive</a></li>
            ...
            <div class="db-right-con messages-con-wrap">
                <table class="table table-hover">
                    ...
                    <form action="{$config.url}/inbox/sent" method="post">
                        <tbody id="userArchiveMessageSection">
                            {include file="hmb_archive_message_template.tpl" nocache}
                        </tbody>
                    </form>
                </table>
            </div>
...
<script language="javascript" type="text/javascript">
    ...
    function searchMessage() {
        $('#userArchiveMessageSection').html('');
        $.ajax({
            type : 'POST',
            url  : '/inbox/userMessageInbox',
            data :  { page : $('#page').val(), action : "archive" },
            dataType : 'json',
            success  : function(data) {
                $('input[name="page"]').val(1);
                $('#userArchiveMessageSection').html(data.html);
            }
        });
    }
</script>