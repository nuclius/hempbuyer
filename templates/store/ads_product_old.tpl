             ...
             <input type="hidden" name="storeid" value="{$storeid}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <div class="col-sm-6">
                            <input class="w100 p15 pb15 grey-bg border-0" type="text" class="form-control" id="ad_name" placeholder="Product Name*" name="ad_name"  data-parsley-required required >
                             <input type="hidden" id="ad_url" class="form-control" value="/product/view/id={$proid}"  name="ad_url" required/>
                            <div class="checkbox">
                          ...
                          <div class="col-sm-6">
                            <!-- <input class="w100 p15 pb15 grey-bg border-0" type="password" class="form-control" id="pwd" placeholder="Ad title" name="pwd"> -->
                            <input class="w100 p15 pb15 grey-bg border-0" type="text" class="form-control" id="brand_name" placeholder="Brand Name (If any)" name="brand_name">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <div class="col-sm-12">
                            ...
                            <textarea class="grey-bg w100 border-0 p15 pb15"  name="ad_content" placeholder="Description" name="name" rows="5" id="desc" cols="80" data-parsley-required required placeholder="Say something about the Product to customers"></textarea>
                          </div>
                          <div class="col-sm-6">
                            ...
                            <div class="row flex">
                              ...
                              <div class="col-md-12 margin-auto">
                                ...
                                <div class="row flex">
                                  ...
                                  <div class="col-md-6 margin-auto">
                                    <span class="f12 m5"><i>Upload Product Image</i></span>
