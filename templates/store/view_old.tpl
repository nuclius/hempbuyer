                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    ...
                                    <form name="recurpur" class="recurpur" id="recurpur" data-parsley-validate>
                                        ...
                                        <div class="col-md-12 m10 checkbox_insurance">
                                            <div class="checkbox">
                                                <label>
                                                    <input name="terms-name" type="checkbox" value="terms">
...
<div class="container-fluid store-view-fluid grey-bg">
    <div class="container store-view-con">
        ...
        <div class="row store-details-row">
            <div class="col-md-12 white-bg shadow p35-15">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="nav nav-pills page-link">
        ...
        <div class="row store-content-row white-bg shadow p35-15">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-sm-5 col-md-3 sidebar  mb-25">
                    ...
                    <div class="col-sm-7 col-md-9 right-content">
                        <div class="row top-bar-row">
                            <div class="col-md-12 flex main-col">
                                ...
                                <div class="col-md-4 margin-auto res-mt">
