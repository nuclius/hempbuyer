...
<div class="container-fluid grey-bg xs-pdlr">
  ...
  <div class="container dashboard-settings-con m50">
    ...
    <div class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown">Edit Your  Brand<i class="fa fa-angle-down"></i></a>
          ...
          <form class="form-horizontal"  data-parsley-validate method="post" enctype="multipart/form-data" action="{$config.url}/adwords/save">
             ...
             <input type="hidden" name="storeid" value="{$adwords_details.store_id}">
                 <input type="hidden" name="store_id" value="{$adwords_details.store_id}">
                  ...
                  <input type="hidden" name="brand_name" value="{$adwords_details.brand_name}" class="brand_name">
                <div class="row">
                    <div class="col-md-12">
                          ...
                          <option value='' > Select Brand Name </option> 
                            {foreach $brand_list as $key => $val}
                                 ...
                                 <option value='{$val.id}'  {if $adwords_details.product_id == $val.id} selected {/if} > {$val.brand} </option>
                           {/foreach}
                        ...
                        <div class="form-group">
                          <div class="col-sm-12">
                           <textarea class="grey-bg w100 border-0 p15 pb15"  name="ad_content" placeholder="Description" name="name" rows="5" id="desc" cols="80" data-parsley-required required placeholder="Say something about the Brand to customers">{$adwords_details.ad_content}</textarea>
                          </div>
                          <div class="col-sm-6">
                                ...
                                <div class="row  ">
                                 ...
                                 {if $adwords_details.banner != ''}
                                  ...
                                  <div class="col-md-6 margin-auto">
                                    ...
                                    <input type="file" name="ad_image" id="banner" multiple="multiple">
                                  </div>
                                   </div>
                              ...
                              <div class="form-group">
                                <div class="col-sm-12">
                                    <div class="inner-addon right-addon">
                                        ...
                                        <input type="text" class="w100 p15 pb15 grey-bg border-0" name="start_date"  id="start_date" placeholder="dd/mm/yyyy"  autocomplete="off" value="{$adwords_details.start_day}" required>
                                    </div>
                                </div>
                          ...
                          <div class="col-sm-12">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                               ...
                               <input class="w100 p15 pb15 grey-bg border-0" type="text" id="per_day" placeholder="Maximum Budget : $5.00 per day" required  data-parsley-min="5" name="per_day_amount" value="{$adwords_details.budget_per_day}">
                              </div>
