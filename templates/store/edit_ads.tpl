                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <div class="col-sm-6">
                           ...
                           <a style ="color:blue" href="{$config.url}{$adwords_details.ad_url}"> Ad url </a>
                             <input type="hidden" name="product_id" value="{$adwords_details.product_id}">
                          </div>
                          <div class="col-sm-6">
                            <!-- <input class="w100 p15 pb15 grey-bg border-0" type="password" class="form-control" id="pwd" placeholder="Ad title" name="pwd"> -->
                            <input class="w100 p15 pb15 grey-bg border-0" type="text" class="form-control" id="ad_title" placeholder="Ad title  " value="{$adwords_details.ad_title}"  name="ad_title" data-parsley-required required >
                          </div>
                        </div>

                        <div class="form-group">
                          <div class="col-sm-6">
                            <input class="w100 p15 pb15 grey-bg border-0" type="text" class="form-control" id="ad_name" placeholder="Product Name*" name="ad_name" value="{$adwords_details.ad_name}"  data-parsley-required required >
                             <input type="hidden" id="ad_url" class="form-control" value="{$adwords_details.ad_url}"  name="ad_url" required/>
                            <div class="checkbox">
                          ...
                          <div class="col-sm-6">
                            <!-- <input class="w100 p15 pb15 grey-bg border-0" type="password" class="form-control" id="pwd" placeholder="Ad title" name="pwd"> -->
                            <input class="w100 p15 pb15 grey-bg border-0" type="text" class="form-control" id="brand_name" placeholder="Brand Name (If any)" name="brand_name" value="{$adwords_details.brand_name}">
                          </div>
                        </div>

                        <div class="form-group">
                          <div class="col-sm-12">
                            <!-- <input class="w100 p15 pb15 grey-bg border-0" type="email" class="form-control" id="email" placeholder="Ad content" name="email"> -->
                          ...
                          <div class="col-sm-6">
                            <!-- <input class="w100 p15 pb15 grey-bg border-0" type="password" class="form-control" id="pwd" placeholder="Ad URL*" name="pwd"> -->
                          </div>
                        </div>
                                ...
                                <div class="row flex">
                                  ...
                                  <div class="col-md-6 margin-auto">
                                    <div class="pro-thumb grey-bg p15">
                                       <img id="imagePreview" src="{$config.url}/uploads/ad_image/{$adwords_details.banner}" class="img-responsive margin-auto" alt="">
                                       <input type="hidden" value="{$adwords_details.banner}" name="old_file">
                                        <input type="hidden" value="{$adwords_details.banner}" name="pre_image">
                                       
                                    </div>
                                  </div>

                                  <div class="col-md-6 margin-auto">
                                    <span class="f12 m5"><i>Upload Product Image (*.jpeg, *.jpg, *.png etc.)</i></span>
                                    <input type="file" accept="image/*"  {if $adwords_details.banner == ''} required {/if} name="ad_image" id="banner" multiple="multiple">
                                  </div>
                          ...
                          <div class="col-sm-12">
                            ...
                            <div class="row testresult">
                                <div class="col-md-12 test-result">
                                  ...
                                  <input type="text" class="form-control" value="{$adwords_details.end_date}" name="end_date"  id="date_addeddd" placeholder="dd/mm/yyyy"  autocomplete="off" >
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <label class="f12">Your bid (the maximum you are willing to pay per click) </label>
                                  ...
                                  <input class="w100 p15 pb15 grey-bg border-0" type="text" id="ppc" placeholder="Minimum bid : US$2.00 Per Click" required    value="{$adwords_details.budget_per_click}" data-parsley-min="2" name="per_click_amount">
                              </div>
                              <div class="col-md-6">
                                <label class="f12">What is the most you're willing to spend per day?  </label>
                                 <input class="w100 p15 pb15 grey-bg border-0" type="text" id="per_day" placeholder="Minimum budget : US$5.00 per day" required data-parsley-min="5" value="{$adwords_details.budget_per_day}"  name="per_day_amount">
                              </div>
