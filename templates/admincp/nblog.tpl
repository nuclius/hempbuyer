...
<div class="container-fluid"> 
  ...
  <div class="row">
    <div class="col-lg-12">
      <ol class="breadcrumb">
        <li class="active"> <i class="icon flaticon-flower-with-leaves"></i>{if $projects.id == 0 or $projects.id == ''} Add {else} Edit {/if} Blog <i class="fa fa-angle-double-right"></i> <i class="fa fa-edit"></i> <i class="fa fa-angle-double-right"></i> {$projects.title} </li>
      </ol>
    </div>
  </div>
  <!-- /.row -->
