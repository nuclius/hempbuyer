    ...
    <!-- Page Heading -->
                ...
                <div class="row">
                    <div class="col-lg-12" style="margin-top:2%;">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <!-- <i class="fa fa-laptop"></i> --> Ads Product
                            </li>
                        </ol>
                    </div>
                </div>
...
<form enctype="multipart/form-data" class="admin_form" data-parsley-validate method="get" enctype="multipart/form-data" action="{$config.url}/admincp/ads/product">
            <div class="row">
                <div class="col-lg-4">
                                 ...
                                 {foreach $banner as $key => $val}
                                    ...
                                    <tr>
                                      ...
                                      <!--  <td></td> -->
                                       ...
                                       <!--  <td><a href="{$config.url}/admincp/banner/edit?id={$val.id}" title="{$val.image}">Edit</a><br /> <a href="{$config.url}/admincp/banner/delete?id={$val.id}" class="deletealert"onclick="return confirm('Are you sure ?') "  title="{$val.image}">Delete</a> </td> -->
                                       </tr>
                                 {/foreach}
                                {else}
                                 <tr>
