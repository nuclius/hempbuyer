                              ...
                              {if $type[$key] == 'radio'}
                                 {foreach $value[$key] as $key2 => $val2}
                                  <span style="display: inline-block;">
                                     <input class="test" type="radio"  name="{$action}[{$key}]" value="{$key2}" {if $val == $key2}checked{/if}   data-parsley-group="block1" style="opacity: 1; position: unset; width: auto;"><span style="float: right;">{$val2}</span>
                                  </span>
                                 {/foreach}
