  ...
  <!-- Page Heading -->
                ...
                <div class="row">
                    <div class="col-lg-12" style="margin-top:2%;">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <!-- <i class="fa fa-laptop"></i> --> {$headings_ads}
                            </li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
<form enctype="multipart/form-data" class="admin_form" data-parsley-validate method="get" enctype="multipart/form-data" action="{$config.url}/admincp/ads/inactive">
            <div class="row">
                <div class="col-lg-4">
...
<div class="table-responsive">
                            <table class="table table-bordered table-hover">
                             ...
                             <!--           <td></td> -->
                                       ...
                                       <!--  <td><a href="{$config.url}/admincp/banner/edit?id={$val.id}" title="{$val.image}">Edit</a><br /></td> -->
                                       </tr>
                                 {/foreach}
                                 {else}
                                 <tr>
