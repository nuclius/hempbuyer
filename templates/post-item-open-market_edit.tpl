            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-pills nav-justified m20 frxs-wd">
                        <li class="{if $projects.trading_type != 'sell'}active{/if}"><a data-toggle="pill" href="#buy">BUY</a></li>
                        <li class="{if $projects.trading_type == 'sell'}active{/if}"><a data-toggle="pill" href="#sell">SELL</a></li>
                    </ul>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-6">
                                            <select class="w100 p15 pb15 grey-bg border-0" name="category" onchange="loadSubcategory(this)" data-parsley-required data-parsley-required-message="Please select category">
                                                ...
                                                {foreach $category as $key => $val} {if $val.parent_id == 0}
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="flex">
                                                <div class="margin-auto">
                                                    ...
                                                    <input type="file" id="filecount2" accept="image/*" name="product_image" multiple="multiple" data-parsley-required data-parsley-required-message="Please select images">
                                                    <!--                                                 <input type="file" id="filecount2" name="product_image" multiple="multiple"> -->
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-9">
                                            <textarea class="grey-bg w100 border-0 p15 pb15" placeholder="Description" name="description" data-parsley-required data-parsley-required-message="description is required" rows="9" cols="80">{$projects.description} {$projects.avatar}</textarea>
                                        </div>
                                    </div>
                                    <div class="row flex">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 testresult">
                                            ...
                                            <div class="margin-auto" style="margin-right:0px;">
                                                ...
                                                <input type="file" id="filecount4" name="test_results" data-parsley-required data-parsley-required-message="Please upload test results" multiple="multiple" accept="image/*" required/>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-6">
                                            <select class="w100 p15 pb15 grey-bg border-0" name="category" onchange="loadSubcategory(this)" r data-parsley-required data-parsley-required-message="Please select category">
                                                ...
                                                <option class="black" value="{$val.id}" {if $projects.parent_category_id==$ val.id} selected {/if}>{$val.name}</option>
                                                {/if} {/foreach}
                                            </select>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-3">
                                            ...
                                            <div class="flex">
                                                <div class="margin-auto">
                                                    <span class="f12 m5"><i>Upload Item Images  (*.jpeg, *.jpg, *.png etc.)</i></span>
                                                    <input type="file" id="filecount5" name="product_image" data-parsley-required-message="Please upload product images" multiple="multiple" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-9">
