...
<div class="col-md-12">
    ...
    <form action="/dashboard/deposit/pay" id="paypal-form" method="post" data-parsley-validate enctype="multipart/form-data">
        ...
        <input type="hidden" name="paymentMethodNonceInputField" id='paymentMethodNonceInputField' />
            ...
            <div class="col-md-2"></div>
                <div class="col-md-2 padle" style="padding-right:0;margin-top: 7px;">
                    <span class="padee5">{$phrase.ledger_balance} </span></div>
                <div class="col-md-4 padle">
                   <span class="curr_symbol">{$currency} </span> {$users.balance_amount}
                    </div>
            ...
            <div class="col-md-2"></div>
                <div class="col-md-2 padle" style="padding-right:0;margin-top: 7px;">
                    <span class="padee5">{$phrase.available_balance}</span></div>
                <div class="col-md-4 padle">
                  <span class="curr_symbol">{$currency} </span>  {$users.balance}
                    </div>
