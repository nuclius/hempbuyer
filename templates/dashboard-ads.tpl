        ...
        <div class="row">
            <div class="col-sm-12 confLinkCol">
                ...
                <ul>
                  ...
                  <a href="#"><li><img src="images/ads.png" alt="">Advertising </li></a>
          ...
          <div class="col-md-12 white-bg-2 p35 shadow">
            ...
            <div class="row">
              ...
              <div class="col-md-8 text-right">
                ...
                <button onclick="window.location.href='ads-product.html'" class="btn btn-default btn-d-b green-b m0 text-transform-inherit" type="button">Ads My Product</button>
                <button onclick="window.location.href='ads-store.html'" class="btn btn-default btn-d-b green-b m0 text-transform-inherit" type="button">Ads My Store</button>
                        ...
                        <tbody>
                         {foreach $adwords_details as $key => $val}
                          <tr>
                            <td>
                              <h4><b class="caption">
                                {$val.ad_title} </b> <a href="#" class="black"><i class="fa fa-pencil icon f12"></i></a>
                              </h4>
                            ...
                            <td class="text-center">{$val.no_of_clicks}/{$val.budget_per_day}</td>
                          </tr>
                          {/foreach}
