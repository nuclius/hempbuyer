...
<!-- page content  -->
 ...
 <ol class="breadcrumb bg-transparent p0">
                ...
                <li><a href="{$config.url}/dashboard/relationship/">Collaboration Center</a></li>
              </ol>
                  <ul class="sidebar-menu">
                        ...
                        <li>
                          <div class="maincat">
                              <!-- <i class="fa fa-user icon green-text" aria-hidden="true"></i> -->
                            <a class="green-text" href="{$config.url}/dashboard/relationship/"><span>Collaborate By Location</a>
                            <!-- <i class="fa fa-angle-left pull-right"></i> -->
                            </div>
                    ...
                    <div class="col-md-12 feed-col">
                      <div class="row flex">
                        <div class="col-md-6 margin-auto">
                          ...
                          <h4 class="m0 black caption m10 m-t-0 green-text"><a href="business-pool-single.html">{$val.subject}</a></h4>

                        </div>
                        <div class="col-md-6 margin-auto">
                          <address class="pull-right">
                          {if $val.from_id == $loged.userid}
                            {$val.taddress1}  <br>
                            {$val.taddress2}<br>
                            {$val.tstate} {$val.tcity}<br>
                            E-Mail: {$val.temail}
                            {/if}
                            {if $val.to_id == $loged.userid}
                            {$val.faddress1}  <br>
                            {$val.faddress2}<br>
                            {$val.fstate} {$val.fcity}<br>
                            E-Mail: {$val.femail}
                            {/if}
                          </address>
                        </div>
                      ...
                      <div class="">
                        ...
                        <ul class="m0 p0 pull-right">
                          ...
                          <li class="inline-block ml-15"><i class="fa fa-usd icon green-text" aria-hidden="true"></i> <span><b class="green-text">Cost of the Message ${$val.cost}</b> <span class="count grey-text"></span></span></li>
                        </ul>
                          {/if}
