                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered1 table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{$config.url}/profile_settings/ratings/{if $loged.business_type == 'dispensary'}buyer{/if}{if $loged.business_type != 'dispensary'}seller{/if}/{$val.id}">
                                                {if $val.comment!=''} {$val.comment} {/if}
                                                {if $val.comment==''} - {/if}
                                            </a>
                                        </td>
                                        <td>
