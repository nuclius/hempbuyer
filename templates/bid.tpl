      ...
      <div class="detail_page_top">
        ...
        <div class="detail_page_top_mid" style="width:580px;">
          ...
          <div class="bid_history" style="" rel="0" name="344">
            ...
            <h3>{$phrase.are_you_sure_you_want_to_bid_this_item_for_price} ${$projects.wsprice}?</h3>
      ...
      <div class="detail_bottom_outer">
        <div class="detail_bottom_outer_top">
          <div class="detail-action_detail">
            <h1>{$phrase.auctions_details}</h1>
            <div class="detail-action_detail_lef">
              <h2>{$phrase.auction_id} : </h2>
          ...
          <div class="detail-action_detail">
            <h1>{$phrase.price_details}</h1>
            <div class="detail-action_detail_lef">
              <h2> {$phrase.price_starting_from} :</h2>
              <h2>{$phrase.start_time} : </h2>
              <h2>{$phrase.end_time} :</h2>
            </div>
            <div class="detail-action_detail_rgt">
          ...
          <div class="detail-action_detail detail_last-bgnone">
            <h1>{$phrase.shipping_details}</h1>
            <div class="detail-action_detail_lef">
              <h2>{$phrase.shipping_fee} :</h2>
              <h2>{$phrase.shipping_information} :</h2>
            </div>
            <div class="detail-action_detail_rgt">
        ...
        <div class="detail_product_description">
          <h1>{$phrase.product_description}</h1>
          <p>{$projects.description}</p>
        </div>
      </div>
