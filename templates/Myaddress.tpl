    ...
    <form action="{$config['url']}/dashboard/Myaddress" method="post" id="shipping" name="shipping" accept-charset="utf-8" data-parsley-validate>
      ...
      <div class="row">
        <div class="form-group">
          <label for="inputEmail" class="col-md-4" >{$phrase.name}:</label>
          <div class="col-md-8">
      ...
      <div class="row">
        <div class="form-group">
          <label for="inputEmail" class="col-md-4" >{$phrase.address_line} 1:</label>
          <div class="col-md-8">
      ...
      <div class="row">
        <div class="form-group">
          <label for="inputEmail" class="col-md-4" >{$phrase.address_line} 2:</label>
          <div class="col-md-8">
      ...
      <div class="row">
        <div class="form-group">
          <label for="inputEmail" class="col-md-4" >{$phrase.country}:</label>
          <div class="col-md-8">
      ...
      <div class="row">
        <div class="form-group">
          <label for="inputEmail" class="col-md-4" >{$phrase.state}:</label>
          <div class="col-md-8">
      ...
      <div class="row">
        <div class="form-group">
          <label for="inputEmail" class="col-md-4" >{$phrase.city}:</label>
          <div class="col-md-8">
      ...
      <div class="row">
        <div class="form-group">
          <label for="inputEmail" class="col-md-4" >{$phrase.zipcode}:</label>
          <div class="col-md-8">
      ...
      <div class="row">
        <div class="form-group">
          <label for="inputEmail" class="col-md-4" >{$phrase.phone_number}:</label>
          <div class="col-md-8">
      ...
      <div class="row">
        ...
        <div class="col-md-2">
          <button class="btn save_btn" type="submit">{$phrase.save}</button>
        </div>
      </div>
    </form>
  </div>
