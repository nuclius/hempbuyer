...
<div class="container">
   ...
   <div class="my_message_right">
      <div class="message_common_border">
         <h1 style="width:168px;" title="Add Product">{$pharse.add_reviews}</h1>
         
      </div>
      <div class="message_common">
      {if $reviewaction} {$pharse.review_submited} {/if}
      <form method="POST" enctype="multipart/form-data" class="admin_form" data-parsley-validate name="add-product" id="add-product" action="/dashboard/review">
         ...
         <p>{$pharse.subject}<span class="red">*</span>  :</p>
          ...
          <p>{$pharse.message}<span class="red">*</span>  :</p>
                  <div class="text_feeld">
                     <h2>
