        ...
        <div class="wrapper">
          <div class="auctions_black_authorize_top_bg">
            ...
            <div class="auctions_black_authorize_top_mid">
              <h2>{$pharse.authorize_authentication}</h2>
            </div>
            ...
            <div class="white_theme_tot_aut">
              <form method="POST" name="authorize_form" action="/package/pay" data-parsley-validate >
                ...
                <div class="card_detail">
                  <label>{$pharse.pay_type:}</label>
                  <select type="payment" name="payment">
                    <option value="paypal">{$pharse.paypal}</option>
                    <option value="authorize">{$pharse.authorize}</option>
                    <option value="stripe">{$pharse.stripe}</option>
                  </select>
                </div>
                <div id="cardPayments" style="display:none;">
                  <div class="card_detail">
                    <label>{$pharse.card_type:}</label>
                    <div class="select_card_type">
                      <div class="top_select">
                        <select name="creditCardType" class="select" title="select_card_type">
                          <option value="Visa" selected="">{$pharse.visa}</option>
                          <option value="MasterCard">{$pharse.mastercard}</option>
                          <option value="Discover">{$pharse.discover}</option>
                          <option value="Amex">{$pharse.american_express}</option>
                        </select>
                      </div>
                    </div>
                  </div>
                  <div class="card_detail">
                    <label>{$pharse.card_number:}</label>
                    <div class="select_card_type">
                  ...
                  <div class="card_detail">
                    <label>{$pharse.expiration_date:}</label>
                    <div class="month">
