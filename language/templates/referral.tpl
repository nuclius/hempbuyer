...
<div class="main_container">
  <div class="row dashboard">
    ...
    <div class="col-md-9">
      <h4 class="ds_brd">{$pharse.refferals}</h4>
      <div class="row mblue_box">
        <div class="col-md-6">{$pharse.referral_link} </div>
        <div class="col-md-6">{$pharse.referral_bonus_per_user_signup}</div>
      </div>
      ...
      <div class="row mblue_box">
        ...
        <div class="col-md-3">{$pharse.name} </div>
        <div class="col-md-3">{$pharse.email} </div>
        <div class="col-md-2">{$pharse.joined}</div>
      ...
      {/foreach}
      {else}
     <div class="col-md-12 text-center m-top-20 font-12">  {$pharse.no_referrals_found} </div> 
      {/if} </div>
  </div>
</div>
</div>
