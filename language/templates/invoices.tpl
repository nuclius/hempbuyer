...
<div class="container">
  ...
  <div class="my_message_right" id="mybids_page">
    <div class="message_common_border">
      <h1 title="MY PRODUCTS">{$pharse.my_bids}</h1>
      <p>&nbsp;</p>
    </div>
        ...
        <div class="forms_common">
          <div class="title_cont_watchilist">
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="table-top">
              <thead>
                <tr>
                  <th  align="center"> <b>{$pharse.description}</b> </th>
                  <th  align="center"> <b>{$pharse.type}</b> </th>
                  <th  align="center"> <b>{$pharse.amount}</b> </th>
                  <th  align="center"> <b>{$pharse.date_added}</b> </th>
                  <th  align="center"> <b>{$pharse.gateway}</b> </th>
                  <th  align="center"> <b> {$pharse.status}</b> </th>
                </tr>
              </thead>
              <tbody>
              ...
              <tr>
                <td colspan="8" align="center">{$pharse.no_bids_found}</td>
              </tr>
              {else}
