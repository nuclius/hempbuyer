...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12" style="margin-top:2%;">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <i class="icon flaticon-flower-with-leaves"></i> {$pharse.dispute} <i class="fa fa-hand-o-right"></i> <i class="fa fa-search"></i> {$pharse.list}
                </li>
            </ol>
        </div>
    </div>
        ...
        <div class="">
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%" >
                ...
                <tr>
                    ...
                    <td><a href="{$config.url}/admincp/del_disputes/{$val.id}"  onclick="return confirmation()"> {$pharse.delete} </a></td>
                </tr>
                {/foreach}
