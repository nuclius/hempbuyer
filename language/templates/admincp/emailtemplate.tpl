...
<div class="container-fluid"> 
  ...
  <div class="row">
    <div class="col-lg-12" style="margin-top:2%;">
      <ol class="breadcrumb">
        <li class="active"> <i class="fa fa-sitemap"></i> {$pharse.email_templates_management} </li>
      </ol>
    </div>
  </div>
  <!-- /.row -->
  <div class="col-lg-12 padt2"> 
  <form name="emailtemp" method="get" action="{$config.url}/admincp/emailtemplate/search" class="form-horizontal">
 
   <div class="col-md-8 reports2 padlef sear">{$pharse.search_email_templates}</div>
 ...
 <div class="col-md-12 reports2 sear">{$pharse.email_templates}</div>
  
  <div class="pull-left">
  <a href="{$config.url}/admincp/addemailtemplate" class="btn btn-success"> {$pharse.add_new_email_template}</a>
  </div>
  ...
  <div class="pull-right padt1">
   ...
   <a href="{$config.url}/admincp/templateimport?temptype=email" style="margin-bottom:10px" class="btn btn-success pull-right">{$pharse.import}</a>
  ...
  <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <td>{$val.type}</td>
                                <td><a href="{$config.url}/admincp/etemps/edit/{$val.id}">{$pharse.edit}</a></td>
