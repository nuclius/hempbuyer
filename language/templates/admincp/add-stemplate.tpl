...
<div class="container-fluid"> 
  ...
  <div class="row">
    <div class="col-lg-12">
      <ol class="breadcrumb">
        <li class="active"> <i class="icon flaticon-flower-with-leaves"></i> {$pharse.add_sms_templates} <i class="fa fa-hand-o-right"></i> <i class="fa fa-search"></i> </li>
      </ol>
    </div>
  </div>
  <!-- /.row -->
  ...
  <div class="row">
   ...
   <form action="{$config.url}/admincp/addstemps" method="post" id="pay_chk">
    ...
    <div class="form-group">
        <label>{$pharse.event_title}</label>
    ...
    <label>{$pharse.template}</label><br/>
