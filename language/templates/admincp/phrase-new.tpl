...
<div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12" style="margin-top:2%;">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-user"></i> {$pharse.phrases} <i class="fa fa-hand-o-right"></i> <i class="fa fa-settings"></i> 
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                       <div class="col-lg-12">
                          {if $error == 'saved'}
                                <div class="alert alert-success"> <strong>Saved!</strong> {$pharse.phrases_was_successfully_changed} </div>
                          {elseif $error != ''}
                                  ...
                                  <div class="col-lg-4">Phrases Text</div>
                                       ...
                                       <div class="col-lg-12">
                                        <div class="col-lg-4" style="margin-bottom:2%">
                                         <div class="col-lg-12" style="margin-bottom:2%">{$pharse.phrases_identifier}</div>
                                        <div class="col-lg-12"><input type="text" value="" class="form-control"  name="phrase_name" /></div></div>

                                        <div class="col-lg-4" style="margin-bottom:2%">
                                        <div class="col-lg-12" style="margin-bottom:2%">{$pharse.phrases_text}</div>
