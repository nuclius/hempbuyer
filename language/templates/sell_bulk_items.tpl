...
<div class="row">
  ...
  <div class="selft26">{$pharse.selling_an_item}</div>
  ...
  <div class="col-xs-12 col-sm-6 col-md-4">
    ...
    <select class="form-control clracac" name="mcid" id="product_category" required>
      <option value="">{$pharse.please_select_category}</option>
...
<div class="row">
  <div class="col-xs-12 col-sm-6 col-md-4 mbtnm_10">
    ...
    <select class="form-control clracac"  name="cid" required>
        ...
        <option value="">{$pharse.please_select_sub_category}</option>
        {foreach $category as $key => $val}
         {if $val.parent_id > 0}
  ...
  <div class="container pribtm15 auction-area">
    <div class="col-xs-12 col-sm-3 col-md-2 lineht30">{$pharse.start_price}</div>
  ...
  <div class="container pribtm15 auction-area">
    <div class="col-xs-12 col-sm-3 col-md-2 lineht30">{$pharse.reserve_price}</div>
    <div class="col-xs-12 col-sm-4 col-md-3">
  ...
  <div class="container pribtm15 buynow-area">
    <div class="col-xs-12 col-sm-3 col-md-2 lineht30">{$pharse.retail_price}</div>
    <div class="col-xs-12 col-sm-4 col-md-3">
       <div class="input-group">
          <span class="input-group-addon"  for="exampleInputName2">$</span>
  ...
  <div class="container pribtm15 buynow-area">
    <div class="col-xs-12 col-sm-3 col-md-2 lineht30">{$pharse.quantity}</div>
    <div class="col-xs-12 col-sm-4 col-md-3">
       <div class=" "> 
  ...
  <div class="container pribtm15 buynow-area">
    <div class="col-xs-12 col-sm-3 col-md-2 lineht30">{$pharse.buy_now_price}</div>
    <div class="col-xs-12 col-sm-4 col-md-3">
       <div class="input-group buynowprice">
          <span class="input-group-addon" for="exampleInputName2">$</span>
  ...
  <div class="bg774 fnt" style=" padding-top: 15px;">{$pharse.is_this_item_at_a_different_location_?_}
    <span><div type="button " val="1" class="btn btn-danger location {if $projects.is_same_location} disabled {/if}" >{$pharse.yes}</div></span>
    <span><div type="button" val="0" class="btn btn-default ashclr location {if !$projects.is_same_location} disabled {/if}">{$pharse.no}</div></span>
    <input type="hidden" name="is_location" value="{$projects.is_same_location}" />
    </div>
   <div class="row pribtm15 list-area    mc mc-5">
    <div class="col-xs-12 col-sm-2 col-md-2 lineht30">{$pharse.product_location}</div>
    ...
    <div>
      <div class="nclracac">{$pharse.description}</div>
    ...
    <div class="form-group fnt">
     ...
     <div class="form-group fnt">
      <label for="exampleInputEmail1" class="nclracac">{$pharse.weight(kgs)} </label>
      <input type="text" class="form-control wd60"  name="weight" value="" required>
    </div>
    
     <div class="form-group fnt">
      <label for="exampleInputEmail1" class="nclracac">{$pharse.height(inch)} </label>
      <input type="text" class="form-control wd60"  name="Heigh" value="" required>
    </div>
    
     <div class="form-group fnt">
      <label for="exampleInputEmail1" class="nclracac">{$pharse.depth} </label>
      <input type="text" class="form-control wd60"  name="depth" value="" required>
    </div>
    
     <div class="form-group fnt">
      <label for="exampleInputEmail1" class="nclracac">{$pharse.width(inch)} </label>
      <input type="text" class="form-control wd60"  name="width" value="" required>
    </div>
    
  <div class="form-group">
    <div class="nclracac">{$pharse.payment_method}</div>
    <div>
  ...
  <div class="row pribtm15">
    <div class="col-xs-12 col-sm-6 col-md-2 lineht30">{$pharse.paypal_e-mail}</div>
...
<div class="form-group">
 ...
 <div class="col-md-12 padding_flude">
    <div class="form-group col-xs-12 col-sm-4 col-md-3 padding_flude">
            <label class="nclracac">{$pharse.start_date}</label>
...
<div class="col-md-12 padding_flude">
    <div class="form-group col-xs-12 col-sm-4 col-md-3 padding_flude">
        <label class="nclracac">{$pharse.ending_date}</label>
...
{else}
 ...
 {/if}
<div class="labwd20">
  <div class="nclracac">{$pharse.shipping}</div>
...
<div class="bg774">{$pharse.is_this_item_free_shipping_?_}
    <span><div type="button " val="1" class="btn btn-danger shipping {if $projects.shipping_price == 0} disabled {/if}" >{$pharse.yes}</div></span>
    <span><div type="button" val="0" class="btn btn-default ashclr shipping {if $projects.shipping_price > 0} disabled {/if}">{$pharse.no}</div></span>
    
</div>
<div class="row pribtm15 free-shipping-area" {if $projects.shipping_price == 0} style="display:none;" {/if}>
    <div class="col-xs-12 col-sm-3 col-md-2 lineht30">{$pharse.shipping_price}</div>
...
<div class="ptm60"> <span class="nclracac">{$pharse.upload_picture}</span>
  ...
  {foreach $image as $key2 => $val2}
      <div class="pro_image pro_image_{$val2.id}">
         ...
         <a href="javascript:void(0);" onclick="$('.pro_image_{$val2.id}').remove(); if($('.pro_image img').length == 0) { $('#uploadBtn').attr('required',''); }"> {$pharse.delete} </a>
       </div>
  {/foreach}
  {/if}    
