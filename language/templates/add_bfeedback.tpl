...
<div class="col-md-12 fdb3 fedbc4z">{$pharse.seller:}{$projects.name}</div>
<div class="col-md-12 cancel1 fedbc3z">{$pharse.leave_feedback_for_seller}</div>
<div class="col-md-12 fedbc2z">{$pharse.review_headline} <span class="fedclr2">*</span> <span class="fedspan">( {$pharse.if_you_could_say_it_in_one_sentence,what_would_you_say?_}) </span></div>
...
<div class="col-md-12 fedbc2z">{$pharse.write_your_review} <span class="fedclr2">*</span> <span class="fedspan">({$pharse.minimum_120_characters})</span></div>
...
<div class="col-md-12 fdb3 fedbc2z">{$pharse.your_ratings} <span class="fedclr2">*</span></div>
...
<div class="fedclr1">({$pharse.click_to_rate_on_scale_of_1-5})</div></div>
