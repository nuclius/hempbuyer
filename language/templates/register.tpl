...
<div class="container">
   <div class="login_head">
      <ul>
         <li><a href="{$config.url}/" title="Home">{$pharse.home}</a></li>
         <li><a><img src="{$config['dpath']}images/arr_bg.png" alt="Arrow" height="11" width="13"></a></li>
         <li class="active"><a href="#" title="Login">{$pharse.register}</a></li>
      </ul>
   </div>
   <div class="login-part">
      <h2 title="LOGIN">{$pharse.register}</h2>
   ...
   <div class="signup_middle">
         ...
         <div class="signup_form block1">
            ...
            <input type="hidden" name="r_id" value="{$r_id}" />
               ...
               <div class="">
                  <div class="log_fields">
                     <div class="colm1_width fl">
                        <p>{$pharse.retype_password}  <span class="red">*</span>:</p>
                     </div>
               ...
               <div class="">
                  <div class="log_fields">
                     <div class="colm1_width fl">
                        <p>{$pharse.first_name}  <span class="red">*</span>:</p>
                     </div>
               ...
               <div class="sign_check">
                  ...
                  <div class="check_opt">
                     ...
                     <p class="remeber1">{$pharse.i_have_read_and_accept_the_terms_and_conditions_and_privacy_policy_and_i_am_over_18_years_of_age}<a href="# " title="Terms and Conditions"></a>
                     </p>
                  </div>
                  <p style="color:red;width:100%;float:left;clear:both;"></p>
               </div>
      ...
      <div class="sign_rgt">
         <h2>{$pharse.already_a_member?}</h2>
         <p>{$pharse.if_so_you_may_want_to} </p>
         <div class="sign_register">
            <div class="signreg_lft"></div>
            <div class="signreg_midd"><a href="{$config.url}/login" title="Sign in">{$pharse.sign_in}»</a></div>
