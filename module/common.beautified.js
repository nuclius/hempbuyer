...
Date.prototype.addDays = function(days) {
    var secsDay = 864e5;
    // there are 86400000 secs in 1 day
...
exports.checkLogin = function(req, res, id) {
    if (typeof req.session === "undefined" && id == 0) {
        if (req.headers.referer) res.writeHead(302, {
            Location: "/login"
        });
        res.end();
        return false;
...
exports.admincheckLogin = function(req, res, id) {
    if (typeof req.session === "undefined" && id == 0) {
        ...
        if (req.session.userid > 0 && id == 1 && req.session.admin == 1) {} else {
            res.writeHead(302, {
                Location: "/admin/login/"
            });
            res.end();
...
exports.loadTemplateHeader = function(req, res, arr) {
    ...
    console.log("------------------ accessed url : " + fullUrl);
    ...
    async.series({
        ...
        if (err) {
            ...
            if (originalurl.indexOf("/dashboard") > -1 || originalurl == "/profile_settings") arr.pageofjs = "/dashboard/";
...
exports.convertMbToKb = function(val) {
    mbvalue = (parseFloat(val) * 1e3).toFixed(2);
    return mbvalue;
};
